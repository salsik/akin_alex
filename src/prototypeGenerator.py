...
if __name__ == "__main__":
    ...
    parser.add_argument("--img_h", "-hh", help="image height", default=576)
    parser.add_argument(
        ##"--json_file_location", "-l", help="path to category/json_files", default="../data/transformerLayout"
        "--json_file_location", "-l", help="path to category/json_files", default="./data/postprocessed"
    ...
    parser.add_argument("--font_path", "-f", help="complete path to font ttf file",default="./resources/fonts/DroidSans.ttf")
    parser.add_argument(
    ...
    for file in os.listdir(dir_path):
        if ".json" in file:
            ...
            dst_folder_path = os.path.join(dst_folder, "")
            ...
            try:
                create_img(elements, dst_file_path, dir_path, real)
                print(file, count)
            except Exception as e:
                print(e, file)
            count += 1
