...
if __name__ == '__main__':
    ...
    # they should be subfolders for each category according to the format of reading files there
    parser.add_argument("--semantic_images_folder", "-s", help="path to generated semantic images",
                        default="data/output_semantic_images_base")                   
    parser.add_argument("--destination_path", "-d", help="path to destination folder",
                        default="data/postprocessed500")
    ...
    # here i changed in the main code to allow it read files in onr folder
    for file in os.listdir(folder_path):
        ...
        if not os.path.exists(dst_path):
            os.mkdir(dst_path)
        get_bounding_boxes(folder_path, file, dst_path, folder_path)
