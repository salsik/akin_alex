...
def create_generator(image_size=64, z_dim=100, filters=64, kernel_size=4, num_of_categories=5):
    ...
    print("genn input shape::",input_layers.shape)
    print("gen cat shape::",category_input.shape)
    print("genn x shape::",x.shape)
...
def create_discriminator(image_size=64, filters=64, kernel_size=4, num_of_categories=5):
    ...
    print("input shape::",input_layers.shape)
    print("cat shape::",category_input.shape)
